...
namespace webdemofinal.Areas.Admin.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,NamePro,DecriptionPro,Category,Price,ImagePro,datetime")] Product product, HttpPostedFileBase ImagePro)
        {
...
"ProductID,NamePro,DecriptionPro,Category,Price,ImagePro,datetime")] Product product,
